...
class PayoutRejectedEmail extends Mailable
{
    ...
    public function __construct($payout, $recipientType, $recipientName, $rejectionReason)
    {
        $this->payout = $payout;
    ...
    {
        return $this->subject('Payout Request Rejected - ₦' . number_format($this->payout->amount, 2))
